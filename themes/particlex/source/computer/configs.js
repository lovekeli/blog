YL.static = {
  ...
  lockedApps: ['yl-system', 'yl-color-picker', 'yl-browser','lctab',"app-music","app-games","app-wallpaperstore","app-note","app-pdf","app-excel","app-pets","yl-color","githubproxy","reader","medium"], // 锁定的应用（不允许被脚本修改）
