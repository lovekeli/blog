...
YLApp.onReady(function () {
    ...
    var vue = new Vue({
        ...
        watch: {
            ...
            settingSelectApp:{
                handler: function (val, oldVal) {
                    YL.vue.configs.settingSelectApp = this.settingSelectApp;
                }
            }
        },
        computed: {
        ...
        methods: {
            syncData:function () {
                ...
                try {
                    ...
                    this.settingSelectApp=configs.settingSelectApp;
            ...
            startSync: function () { 
                switch(YL.vue.configs.settingSelectApp){
                    case 0: //无
                        ;break;
                    case 1: //系统设置
                        ;break;
