window.YL = {
  info: {
    ...
    iconBtnStart: 'yoast',
    author: '罗小黑',
    contactInformation: 'admin@qq.com',
    officialWebsite: 'https://onlylovekeli.cn',
    copyrightDetail: '禁止非法获取网站资源。',
    otherStatements: '',
  },
  data: {},
  lang: function (key) {
  ...
  _baseData: function () {
    return {
      ...
      configs: {
        ...
        sound: false,//开启声音
        wallpapertype: 'img',
        wallpaper: './res/img/wallpapers/win10.jpng',
  ...
  loadRes: function () {
    ...
    document.getElementById('loading-software-name').innerHTML = '量子计算机';
  ...
  setWallpaper: function (url,type='img') {
    let msg=[];
    msg['event']='wallpaper';
    let data={};
    data.url=url;
  ...
  util: {
    ...
    openWebProxyTool: function () { 
      document.getElementById('reflect').hidden=false;
    },
    closeWebProxyTool: function () { 
      document.getElementById('reflect').hidden=true;
    },
  ...
  child: {
    ...
    setWallpaper: function (type,url, id) {
      return YL.setWallpaper(type,url);
    },
